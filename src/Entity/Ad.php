 ...
 * @UniqueEntity(
 * fields={"title"},
 * message="Une autre annonce a déja ce titre ou cet alias, veuillez le changer"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=10,max=255,minMessage="Le titre doit faire  + de 10 caractères", maxMessage="Votre titre est trop long, mettre max 255 caractères" )
     */
    private $title;
    ...
    public function averageRatings(){
        //somme de toute les notes
            $num = array_reduce($this->comments->toArray(),function($total,$comment){

                //on retourne total + la note de chaque commentaire
                return $total + $comment->getRating();
            },0);
             
           if(count($this->comments) > 0) return $num / count($this->comments);
           return 0;
    }
